...
//     console.log("Back clicked, should render Items (menu)"); // Debug log
//     onBack(); // Trigger switch to Items
//   };
...
//     >
//       <motion.button
//         onClick={handleBackClick} // Wrapped for debugging
//         onTouchStart={(e) => e.preventDefault()} // Prevent mobile touch issues
//         onTouchEnd={handleBackClick} // Ensure tap works on mobile
